...
EXTOBJS =$(GBUTIL_OBJ)/StringStuff.o #$(GBUTIL_OBJ)/BinomFact.o #$(GBUTIL_OBJ)/StringStuff.o $(GBUTIL_OBJ)/Interpolant.o \
...
#EXTOBJS =$(GBFITS_DIR)/FITS.o $(GBFITS_DIR)/Header.o $(GBFITS_DIR)/Hdu.o \
...
$(SHARED): $(OBJDIR)/%.so : $(SUBOBJS) $(EXTOBJS)
	$(CXX) -shared -fPIC -o $(OBJDIR)/libtest.so $(SUBOBJS) $(EXTOBJS)
